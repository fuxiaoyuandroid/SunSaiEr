package com.tcoj.framelibrary.db.curd;

import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;

import com.tcoj.framelibrary.db.DaoUtil;
...
public class QuerySupport<T> {
    ...
    public List<T> query(){
        Cursor cursor  = mSQLiteDatabase.query(DaoUtil.getTableName(mClass),mQueryColumns,mQuerySelection,mQuerySelectionArgs,mQueryGroupBy,mQueryHaving,mQueryOrderBy,mQueryLimit);
        clearQueryParams();
